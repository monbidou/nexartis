-- ============================================
-- ARTIDOC — Reset complet de la base de données
...
DROP FUNCTION IF EXISTS generate_devis_numero() CASCADE;
DROP FUNCTION IF EXISTS update_updated_at() CASCADE;


-- ============================================
-- 3) Suppression de toutes les tables (ordre inverse des dépendances)
-- ============================================
DROP TABLE IF EXISTS relances CASCADE;
DROP TABLE IF EXISTS documents CASCADE;
DROP TABLE IF EXISTS achats CASCADE;
DROP TABLE IF EXISTS planning_interventions CASCADE;
...
-- ============================================
-- 4) Recréation complète du schéma
-- ============================================
...
CREATE INDEX idx_clients_nom ON clients(user_id, nom);
...
CREATE INDEX idx_intervenants_user ON intervenants(user_id);
...
CREATE INDEX idx_prestations_user ON prestations(user_id);
CREATE INDEX idx_prestations_categorie ON prestations(user_id, categorie);
...
CREATE INDEX idx_chantiers_user ON chantiers(user_id);
CREATE INDEX idx_chantiers_client ON chantiers(user_id, client_id);
CREATE INDEX idx_chantiers_statut ON chantiers(user_id, statut);
...
CREATE INDEX idx_devis_client ON devis(user_id, client_id);
CREATE INDEX idx_devis_statut ON devis(user_id, statut);
...
CREATE INDEX idx_factures_client ON factures(user_id, client_id);
CREATE INDEX idx_factures_statut ON factures(user_id, statut);
...
CREATE INDEX idx_planning_user ON planning_interventions(user_id);
CREATE INDEX idx_planning_date ON planning_interventions(user_id, date_debut);
CREATE INDEX idx_planning_intervenant ON planning_interventions(user_id, intervenant_id);
...
CREATE INDEX idx_achats_fournisseur ON achats(user_id, fournisseur_id);
CREATE INDEX idx_achats_chantier ON achats(user_id, chantier_id);
...
CREATE INDEX idx_documents_ref ON documents(reference_type, reference_id);
